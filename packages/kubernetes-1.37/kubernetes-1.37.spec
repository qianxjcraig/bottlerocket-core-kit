...
URL: https://%{goimport}
Source0: https://distro.eks.amazonaws.com/kubernetes-1-37/releases/%{releasever}/artifacts/kubernetes/v%{gover}/kubernetes-src.tar.gz
...
%package -n %{_cross_os}kubelet-1.37
Summary: Container cluster node agent
Requires: %{_cross_os}conntrack-tools
Requires: %{_cross_os}containerd
Requires: %{_cross_os}findutils
Requires: %{_cross_os}ecr-credential-provider-1.37
Requires: %{_cross_os}aws-iam-authenticator
Requires: %{_cross_os}static-pods

%description -n %{_cross_os}kubelet-1.37
%{summary}.

%package -n %{_cross_os}kube-proxy-1.37
Summary: Container cluster node proxy
Requires: %{_cross_os}kubelet-1.37

%description -n %{_cross_os}kube-proxy-1.37
%{summary}.
...
%files -n %{_cross_os}kubelet-1.37
...
%files -n %{_cross_os}kube-proxy-1.37
